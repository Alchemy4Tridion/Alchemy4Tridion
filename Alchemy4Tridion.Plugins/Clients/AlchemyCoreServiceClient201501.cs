...
namespace Alchemy4Tridion.Plugins.Clients
{
    ...
    /// </remarks>
    public class AlchemyCoreServiceClient201501 : IDisposable, IAlchemyCoreServiceClient
    {
        private ISessionAwareCoreService201501 channel;
        ...
        /// </summary>
        public ISessionAwareCoreService201501 Channel
        {
            get
            {
                return this.channel;
        ...
        /// Finalizer
        /// </summary>
        ~AlchemyCoreServiceClient201501()
        {
            Dispose(false);
        }
    }
