...
{
	[GeneratedCode("System.Runtime.Serialization", "4.0.0.0"), DebuggerStepThrough, DataContract(Name = "ItemsFilterData", Namespace = "http://www.sdltridion.com/ContentManager/R6"), KnownType(typeof(OrganizationalItemItemsFilterData)), KnownType(typeof(RepositoryItemsFilterData))]
	public class ItemsFilterData : SubjectRelatedListFilterData
	{
		...
		private bool? ShowDynamicVersionIfReadableByUserField;
		...
		[DataMember(Order = 8)]
		public bool? ShowDynamicVersionIfReadableByUser
		{
			get
			{
