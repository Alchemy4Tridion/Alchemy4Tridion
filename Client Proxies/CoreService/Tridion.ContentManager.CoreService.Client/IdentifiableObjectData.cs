...
{
	[GeneratedCode("System.Runtime.Serialization", "4.0.0.0"), DebuggerStepThrough, DataContract(Name = "IdentifiableObjectData", Namespace = "http://www.sdltridion.com/ContentManager/R6"), KnownType(typeof(WorkflowObjectData)), KnownType(typeof(ActivityData)), KnownType(typeof(WorkItemData)), KnownType(typeof(ActivityInstanceData)), KnownType(typeof(ActivityHistoryData)), KnownType(typeof(ProcessData)), KnownType(typeof(ProcessInstanceData)), KnownType(typeof(ProcessHistoryData)), KnownType(typeof(ActivityDefinitionData)), KnownType(typeof(TridionActivityDefinitionData)), KnownType(typeof(SystemWideObjectData)), KnownType(typeof(RepositoryData)), KnownType(typeof(PublicationData)), KnownType(typeof(BluePrintNodeData)), KnownType(typeof(TrusteeData)), KnownType(typeof(UserData)), KnownType(typeof(AccessTokenData)), KnownType(typeof(GroupData)), KnownType(typeof(MultimediaTypeData)), KnownType(typeof(PublishingTargetData)), KnownType(typeof(TargetTypeData)), KnownType(typeof(PublicationTargetData)), KnownType(typeof(ApprovalStatusData)), KnownType(typeof(BatchData)), KnownType(typeof(RegisteredTypeData)), KnownType(typeof(WorkflowTypeData)), KnownType(typeof(PublishTransactionData)), KnownType(typeof(ProcessDefinitionAssociationData)), KnownType(typeof(RepositoryLocalObjectData)), KnownType(typeof(ProcessDefinitionData)), KnownType(typeof(TridionProcessDefinitionData)), KnownType(typeof(OrganizationalItemData)), KnownType(typeof(FolderData)), KnownType(typeof(StructureGroupData)), KnownType(typeof(VirtualFolderData)), KnownType(typeof(ResolvedBundleData)), KnownType(typeof(CategoryData)), KnownType(typeof(BusinessProcessTypeData)), KnownType(typeof(KeywordData)), KnownType(typeof(TargetGroupData)), KnownType(typeof(VersionedItemData)), KnownType(typeof(ComponentData)), KnownType(typeof(PageData)), KnownType(typeof(TemplateData)), KnownType(typeof(ComponentTemplateData)), KnownType(typeof(PageTemplateData)), KnownType(typeof(TemplateBuildingBlockData)), KnownType(typeof(SchemaData)), KnownType(typeof(BundleTypeData))]
