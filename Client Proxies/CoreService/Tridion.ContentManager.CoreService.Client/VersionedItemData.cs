...
{
	[GeneratedCode("System.Runtime.Serialization", "4.0.0.0"), DebuggerStepThrough, DataContract(Name = "VersionedItemData", Namespace = "http://www.sdltridion.com/ContentManager/R6"), KnownType(typeof(BundleTypeData)), KnownType(typeof(PageData)), KnownType(typeof(SchemaData)), KnownType(typeof(ComponentData)), KnownType(typeof(TemplateData)), KnownType(typeof(ComponentTemplateData)), KnownType(typeof(PageTemplateData)), KnownType(typeof(TemplateBuildingBlockData))]
